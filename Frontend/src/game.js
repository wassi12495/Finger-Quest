class Game {
  ...
  static renderGame() {
    ...
    <div id="player" style="bottom: 0px; left: 350px;">
      <img src="https://www.emojirequest.com/images/ThumbsDownEmoji.jpg" style="width: 100%; height: 100%">
    </div>`;
  }
  ...
  static lossRender() {
    return `<img src="${
      Level.currLevel.playerLoseGif
    }" style="width: 100%; height: 50%"><div id="scorediv"><input type="text" id="username" placeholder="Enter Name"></input> <label style="background-color: white">Your Score: ${
      Player.score
    }</label>  <button id="submit">Submit</button></div>`;
  }
  static winRender() {
    return `<img src="${
      Level.currLevel.bossLoseGif
    }" style="width: 100%; height: 50%"><div id="scorediv"><input type="text" id="username" placeholder="Enter Name"></input>  <label style="background-color: white">Your Score: ${
      Player.score
    }</label>  <button id="submit">Submit</button></div>`;
  }
  ...
  static endGame() {
    ...
    button.addEventListener("click", e => {
      ...
      document.getElementById("scorediv").innerHTML =
        '<h3 style="color:white;" id="endgame"> Try Again?</h3><br><button id="newgame"> New Game</button>';
